...
class ManagerDashboard extends React.Component {
  ...
  handleSelect(e) {
    ...
    switch (id) {
      case 'profile':
        this.setState({
          point: <Profile current_user={this.props.current_user}
            foundation={this.props.foundation} />
        })
        break;
      case 'foundation':
      ...
      case 'groups':
        this.setState({
          point: <LevelsPanel levels={this.props.levels}
      ...
      case 'students':
        this.setState({
          point: <TableOfStudents students={this.state.students}
            foundation={this.state.foundation}
            OpenCloseAlert={this.OpenCloseAlert}
            SetMessageAlert={this.SetMessageAlert}
            SetTypeAlert={this.SetTypeAlert} />
      ...
      case 'invites':
        this.setState({
          point: <TableOfInvites invites={this.props.invites}
            foundation={this.state.foundation}
            OpenCloseAlert={this.OpenCloseAlert}
      ...
      case 'courses':
        this.setState({
          point: <CoursesPanel student={false}
      ...
      case 'requests':
        this.setState({
          point: <TableOfRequests requests={this.state.requests}
            OpenCloseAlert={this.OpenCloseAlert}
            SetMessageAlert={this.SetMessageAlert}
            SetTypeAlert={this.SetTypeAlert} />
        })
